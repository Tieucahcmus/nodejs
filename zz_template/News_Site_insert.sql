...
-- subcategory
INSERT INTO `news_site`.`subcategory` (`name`, `slug_name`, `id_category`) VALUES ('Liên Minh Huyền Thoại', 'LMHT', '1');
...
-- writer
INSERT INTO `news_site`.`writer` (`pseudonym`, `id_user`) VALUES ('Shizuka', '3');
